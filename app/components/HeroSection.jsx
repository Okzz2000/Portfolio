...
const HeroSection = () => {
  const openPDF = () => {
    window.open("/export/pdf-test.pdf", "_blank");
  };
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <div>
            ...
            <button
              onclick={openPDF}
              className="px-1 py-1 sm:fit rounded-full bg-gradient-to-br from-red-500 via-orange-500 to-yellow-500 text-white mt-3"
            >
